"""Module for assignment 12.2"""

# Scraping Numbers from HTML using BeautifulSoup
# In this assignment you will write a Python program similar
# to http://www.py4e.com/code3/urllink2.py.
# The program will use urllib to read the HTML from the data files below, 
# and parse the data, extracting numbers and compute 
...
# Actual data: http://py4e-data.dr-chuck.net/comments_1995356.html (Sum ends with 14)
# 
...
# You need to adjust this code to look for span tags and 
# pull out the text content of the span tag, convert them to integers 
